...
<script type="text/javascript">
  ...
  rules: {
	...
	<div id="main-wrapper">
		<div class="ic"></div>
		<div id="content">
			<h1><span>Edit Menu</span></h1>
			<div id="content-wrapper">
				<div class="table">
					<form id="edit-client" action="index.php?option=onlinejobs&view=clients&task=edit" method="post">
						<fieldset class="form">
							<div class="column cols-2" id="column1">
								<input id="id" type="hidden" name="id" value="<?php echo $sel_row[0]['cid']; ?>"/>
