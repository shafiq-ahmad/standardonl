	...
	<div id="main-wrapper">
		<div id="content">
			...
			<div id="content-wrapper">
				<table class="table">
					<tr class="row head-row"><th class="id">ID</th><th class="email">Title</th><th class="name">Status</th><th class="actopm">Action</th></tr>
					<?php $counter=0; $class = ''; ?>
					<?php foreach ($rows as $row): ?>
						...
						<tr class="row <?php echo $class; ?>" >
							...
							<td class="email"><?php echo $row['title']; ?></td>
							<td class="name">
