					...
					<form id="edit-franchise" action="index.php?option=onlinejobs&view=franchises" method="post">
						<fieldset class="form">
							<div class="column cols-2" id="column1">
								...
								<p><label>Login Name: </label><input id="user_name" readonly class=" required inputbox form-field" type="text" name="user_name" value="<?php echo $sel_row[0]['login_name']; ?>"/></p>
								<p><label>Name: </label><input id="full_name" class=" required inputbox form-field" type="text" name="full_name" value="<?php echo $sel_row[0]['name']; ?>" size="15" /></p>
								<p><label>Franchise Name: </label><input id="franchise" class=" required inputbox form-field" type="text" name="franchise" value="<?php echo $sel_row[0]['franchise_name']; ?>" size="15" /></p>
								<p>
									<label>Type: </label>
								...
								<p><label>E-mail: </label><input id="email" class=" required inputbox form-field" type="text" name="email" value="<?php echo $sel_row[0]['e_mail']; ?>" size="15" /></p>
							...
							<div class="column cols-2" id="column2">
								...
								<p><input id="published" class="checkbox form-field" type="hidden" name="published" value="<?php echo $sel_row[0]['published']; ?>" size="15" /></p>
								<input id="fid" type="hidden" name="fid" value="<?php echo $sel_row[0]['fid']; ?>" />
							</div>
